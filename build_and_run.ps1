...
g++ src\main.cpp src\Dino.cpp src\Obstacles.cpp src\UIManager.cpp -o DinosaurGame.exe -I.\include -I.\freeglut\freeglut\include -L.\freeglut\freeglut\lib\x64 -lfreeglut -lglu32 -lopengl32
