...
g++ src/main.cpp src/Dino.cpp src/Obstacles.cpp -o DinosaurGame.exe -Iinclude -I.\freeglut\freeglut\include -L.\freeglut\freeglut\lib -lfreeglut -lglu32 -lopengl32
